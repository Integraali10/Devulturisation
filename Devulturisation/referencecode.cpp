...
//		for (int j = 0; j < 8; j++)
//		{
//			superS[i*8+j] = aanscalefactor[j]*aanscalefactor[i]*64;
//		}
//	}
//}
//
...
//
//    inptr[0] = (tmp0 + tmp7) / 64;
//    inptr[7] = (tmp0 - tmp7) / 64;
//    inptr[1] = (tmp1 + tmp6) / 64;
//    inptr[6] = (tmp1 - tmp6) / 64;
//    inptr[2] = (tmp2 + tmp5) / 64;
//    inptr[5] = (tmp2 - tmp5) / 64;
//    inptr[3] = (tmp3 + tmp4) / 64;
//    inptr[4] = (tmp3 - tmp4) / 64;
//
