...
__kernel void devultur_most(const __global uchar* pic, __global ushort* res, const __global float *fquant, const __global float *iquant, int rsize, int offset)
{
  ...
  uint lrn = l64 / 4;
  uint lcn = l64 % 4;
  //êàçàëîñü áû, èíäåêñ ïåðâîãî ýëåìåíòà âíóòðè äàííûõ îäíîé ëîêàëüíîé ãðóïïû
  uint gr = get_group_id(1)*LOSI;
  uint gc = get_group_id(0)*LOSI;
  //âîò ãäå-òî òóò íàäî çàäóìàòüñÿ î ñìåùåíèè óêàçàòåëåé íà îïðåäåëåííûé øàã
  ...
  //à òóò - çàïèñü èç ãëîáàëüíîé ? Áåç ñîçíàíèÿ æå ïèñàëîñü
...
#pragma unroll
  ...
  //3. çàïèñü-ñóììèðîâàíèå ñ ïðåãðàäàìè è êîíÿìè âíóòðè ëîêàëüíîé ãðóïïû
#pragma unroll
...
#pragma unroll
  ...
  //4. çàïèñü äàííûõ àêêóðàòíî â ãëîá
  //íåäîïèñü - äîïåøè
